...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
        ...
        XXXXXXX, KC_TAB,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                                           KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, XXXXXXX,
                 KC_LCTL, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_GRV,  KC_INS,  KC_PSCR,  KC_RBRC,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RCTL,
                                            KC__MUTE,XXXXXXX, KC_LSFT, MT_SPC,  MT_LALT, MT_RALT,  MO(_LOWER),KC_RSFT, XXXXXXX, KC_LGUI
    ),
    [_LOWER] = LAYOUT(
    ...
    [_RAISE] = LAYOUT(
                 ...
                 _______, XXXXXXX, KC_EXLM, KC_AT,   KC_HASH, XXXXXXX,                                     KC_0,    KC_1,    KC_2,    KC_3,    KC_0,    XXXXXXX,
        XXXXXXX, _______, XXXXXXX, KC_DLR,  KC_PERC, KC_CIRC, KC_DEL,                                      KC_BSPC, KC_4,    KC_5,    KC_6,    KC_0,    XXXXXXX, XXXXXXX,
